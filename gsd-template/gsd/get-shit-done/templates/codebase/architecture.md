...
- Physical file paths for detailed locations (that's STRUCTURE.md)

## Related Templates

This template complements STRUCTURE.md:

| Template | Focus | Agent Use Case |
|----------|-------|----------------|
| ARCHITECTURE.md | Conceptual: "How components interact" | gsd-planner decides module boundaries |
| STRUCTURE.md | Physical: "Where files live" | gsd-executor creates files at correct paths |

**Key distinction:**
- ARCHITECTURE.md answers: "Which layer/module owns this feature?"
- STRUCTURE.md answers: "Which directory should I put this file in?"

**Agent context flow:**
1. gsd-planner reads ARCHITECTURE.md → determines module design
2. gsd-planner reads STRUCTURE.md → maps to actual file paths
3. gsd-executor uses both → creates files in correct module + location
