...
**Cross-template note:** CONVENTIONS captures "how to write", while ARCHITECTURE captures "how it's designed", and STRUCTURE captures "where files live".

## Related Templates

CONVENTIONS.md works with STRUCTURE.md and ARCHITECTURE.md:

| Template | Question Answered | Agent Use |
|----------|-------------------|-----------|
| CONVENTIONS.md | "How do I name/write this code?" | gsd-executor follows when writing |
| STRUCTURE.md | "Where do I put this file?" | gsd-executor follows when creating |
| ARCHITECTURE.md | "Which module owns this?" | gsd-planner decides module boundaries |

**Agent usage:**
- gsd-planner reads all three for complete context
- gsd-executor uses CONVENTIONS for code style, STRUCTURE for file locations
- When creating new feature: ARCHITECTURE → STRUCTURE → CONVENTIONS
