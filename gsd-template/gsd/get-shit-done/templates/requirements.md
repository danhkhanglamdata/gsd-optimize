...
When planning, agents should reference these files:
- `.planning/codebase/STRUCTURE.md` - Where files go
- `.planning/codebase/CONVENTIONS.md` - How to name/write code
- `.planning/codebase/ARCHITECTURE.md` - Module boundaries
- `.planning/codebase/STACK.md` - Technology choices

These files are created during project initialization and inform implementation decisions.
